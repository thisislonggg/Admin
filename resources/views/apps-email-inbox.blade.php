        ...
        <div class="email-leftbar">
            ...
            <div class="card mt-3">
                <div class="card-body">
                    ...
                    <div class="">
                        <a href="#" class="media">
                            <img class="d-flex me-3 rounded-circle" src="{{URL::asset('assets/images/users/user-1.jpg')}}" alt="Generic placeholder image" height="36">
                        ...
                        <a href="#" class="media">
                            <img class="d-flex me-3 rounded-circle" src="{{URL::asset('assets/images/users/user-2.jpg')}}" alt="Generic placeholder image" height="36">
                            <div class="media-body chat-user-box">
                        ...
                        <a href="#" class="media">
                            <img class="d-flex me-3 rounded-circle" src="{{URL::asset('assets/images/users/user-3.jpg')}}" alt="Generic placeholder image" height="36">
                            <div class="media-body chat-user-box">
                        ...
                        <a href="#" class="media">
                            <img class="d-flex me-3 rounded-circle" src="{{URL::asset('assets/images/users/user-4.jpg')}}" alt="Generic placeholder image" height="36">
                            <div class="media-body chat-user-box">
            ...
            <div class="card my-3">
                <ul class="message-list">
                    ...
                    <li>
                        ...
                        <div class="col-mail col-mail-2">
                            <a href="" class="subject"><span class="badge-soft-warning badge me-2">Freelance</span>Since you asked... and i'm
                    ...
                    <li>
                        ...
                        <div class="col-mail col-mail-2">
                            <a href="" class="subject"><span class="badge-soft-info badge me-2">Support</span>Off on Thursday &nbsp;–&nbsp;
                    ...
                    <li>
                        ...
                        <div class="col-mail col-mail-2">
                            <a href="" class="subject"><span class="badge-soft-pink badge me-2">Friends</span>Weekend on Revibe &nbsp;–&nbsp;
                    ...
                    <li>
                        ...
                        <div class="col-mail col-mail-2">
                            <a href="" class="subject"><span class="badge-soft-purple badge me-2">Social</span>Task assigned: Clone ARP's website
                    ...
                    <li>
                        ...
                        <div class="col-mail col-mail-2">
                            <a href="" class="subject"><span class="badge-soft-info badge me-2">Support</span>Home again! &nbsp;–&nbsp; <span class="teaser">That's just perfect! See you tomorrow.</span>
                            </a>
