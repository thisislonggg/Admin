...
<div class="row">
        ...
        <div class="card">
            <div class="card-body">
                <div class="pricingTable1 text-center">
                    ...
                    <img src="assets/images/small/p-2.png" alt="" class="d-block mx-auto" height="120">
    ...
    <div class="col-lg-3">
        <div class="card">
            <div class="card-body">
                <div class="pricingTable1 text-center">
                    <img src="assets/images/small/p-3.png" alt="" class="" height="120">
    ...
    <div class="col-lg-3">
        <div class="card">
            <div class="card-body">
                <div class="pricingTable1 text-center">
                    <img src="assets/images/small/p-4.png" alt="" class="" height="120">
