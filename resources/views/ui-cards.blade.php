...
<div class="row">
    <div class="col-md-6 col-lg-3">
        <div class="card">
            <img class="card-img-top img-fluid bg-light-alt" src="{{URL::asset('assets/images/small/img-4.jpg')}}" alt="Card image cap">
    ...
    <div class="col-md-6 col-xl-3">
        ...
        <div class="card">
            ...
            <!--end card-body-->
            <p class="card-footer bg-light-alt m-0">Footer - 2020 Metrica</p>
        </div>
        <!--end card-->
...
<div class="row">
    <div class="col-lg-6">
        <div class="card-group mb-3">
            <div class="card">
                <img class="img-fluid bg-light-alt" src="{{URL::asset('assets/images/small/ex-card.png')}}" alt="Card image">
                <div class="card-header">
        ...
        <div class="card mb-3">
            <div class="row g-0">
                <div class="col-md-4 bg-light-alt align-self-center">
                    <img src="{{URL::asset('assets/images/small/ex-card.png')}}" alt="..." class="img-fluid bg-light-alt">
                </div>
                <div class="col-md-8">
                    <div class="card-body">
    ...
    <div class="col-lg-6">
        <div class="row row-cols-1 row-cols-md-2 gx-3">
            <div class="col">
                <div class="card">
                    <img src="{{URL::asset('assets/images/small/ex-card.png')}}" class="card-img-top bg-light-alt" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Card title</h5>
