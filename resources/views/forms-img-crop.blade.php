...
@section('css')
<link href="{{URL::asset('assets/plugins/cropper/css/cropper.css')}}" rel="stylesheet" type="text/css" />
<link href="{{URL::asset('assets/plugins/cropper/css/main.css')}}" rel="stylesheet" type="text/css" />
@endsection
@section('content')
<!-- this is breadcrumbs -->
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="img-container mb-0">
                    <img id="image" src="{{URL::asset('assets/images/small/img-1.jpg')}}" alt="Picture">
                </div>
            </div>
            <!--end card-body-->
        </div>
...
@endsection
@section('script')
<script src="{{URL::asset('assets/plugins/cropper/js/cropper.js')}}"></script>
<script src="{{URL::asset('assets/plugins/cropper/js/main.js')}}"></script>
<script>
