            ...
            <div class="card-body">
                <div class="row d-flex justify-content-center">
                    <div class="col">
                        <div class="media">
                            <a class="" href="#">
                                <img src="{{URL::asset('assets/images/users/user-8.jpg')}}" alt="user" class="rounded-circle thumb-sm">
                            </a>
                    ...
                    <div class="col">
                        <div class="img-group">
                            <a class="user-avatar" href="#">
                                <img src="{{URL::asset('assets/images/users/user-8.jpg')}}" alt="user" class="thumb-sm rounded-circle">
                            </a>
                    ...
                    <div class="col">
                        <div class="img-group">
                            <a class="user-avatar me-1" href="#">
                                <img src="{{URL::asset('assets/images/users/user-10.jpg')}}" alt="user" class="rounded-circle thumb-sm">
                                <span class="avatar-badge online"></span>
                            </a>
                            <a class="user-avatar me-1" href="#">
                                <img src="{{URL::asset('assets/images/users/user-4.jpg')}}" alt="user" class="rounded-circle thumb-sm">
                                <span class="avatar-badge offline"></span>
                            </a>
                            <a class="user-avatar me-1" href="#">
                                <img src="{{URL::asset('assets/images/users/user-1.jpg')}}" alt="user" class="rounded-circle thumb-sm">
                                <span class="avatar-badge online"></span>
                            </a>
                        </div>
                        <!--end img-group-->
