...
@endsection
@section('script')
<script src="{{URL::asset('assets/plugins/select/selectr.min.js')}}"></script>
<script src="{{URL::asset('assets/plugins/huebee/huebee.pkgd.min.js')}}"></script>
<script src="{{URL::asset('assets/plugins/datepicker/datepicker-full.min.js')}}"></script>
<script src="{{URL::asset('assets/plugins/moment/moment.js')}}"></script>
<script src="{{URL::asset('assets/plugins/imask/imask.js')}}"></script>
<script src="{{URL::asset('assets/pages/forms-advanced.js')}}"></script>
@endsection
