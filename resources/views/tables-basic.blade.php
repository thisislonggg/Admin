            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table mb-0 table-centered">
                        ...
                        <tbody>
                            <tr>
                                <td><img src="{{URL::asset('assets/images/small/project-1.jpg')}}" alt="" class="rounded-circle thumb-xs me-1">
                                    Micromin
                                </td>
                                <td>4</td>
                                <td>$250</td>
                            ...
                            <tr>
                                <td><img src="{{URL::asset('assets/images/small/project-2.jpg')}}" alt="" class="rounded-circle thumb-xs me-1">
                                    ZZ Diamond
                                </td>
                                <td>2</td>
                                <td>$180</td>
                            ...
                            <tr>
                                <td><img src="{{URL::asset('assets/images/small/project-3.jpg')}}" alt="" class="rounded-circle thumb-xs me-1">
                                    Dairy Sweet
                                </td>
                                <td>6</td>
                                <td>$210</td>
                            ...
                            <tr>
                                <td><img src="{{URL::asset('assets/images/small/project-4.jpg')}}" alt="" class="rounded-circle thumb-xs me-1">
                                    Corner Tea
                                </td>
                                <td>3</td>
                                <td>$80</td>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped mb-0">
                        ...
                        <tbody>
                            <tr>
                                <td><img src="{{URL::asset('assets/images/users/user-3.jpg')}}" alt="" class="rounded-circle thumb-xs me-1"> Aaron Poulin</td>
                            ...
                            <tr>
                                <td><img src="{{URL::asset('assets/images/users/user-4.jpg')}}" alt="" class="rounded-circle thumb-xs me-1"> Richard Ali</td>
                            ...
                            <tr>
                                <td><img src="{{URL::asset('assets/images/users/user-5.jpg')}}" alt="" class="rounded-circle thumb-xs me-1"> Juan Clark</td>
                            ...
                            <tr>
                                <td><img src="{{URL::asset('assets/images/users/user-6.jpg')}}" alt="" class="rounded-circle thumb-xs me-1"> Albert Hull</td>
