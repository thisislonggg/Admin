                ...
                <div class="text-slider">
                    <ul class="list-inline move-text mb-0">
                        <li class="list-inline-item">
                            <img src="{{URL::asset('assets/images/logos/btc.png')}}" alt="" class="thumb-xs rounded">
                            <span class="fw-semibold font-14">USD: 8435.21</span>
                            <span class="mb-0 font-12 text-success">+7.88%</span>
                        </li>
                        <li class="list-inline-item">
                            <img src="{{URL::asset('assets/images/logos/dash.png')}}" alt="" class="thumb-xs rounded">
                            <span class="fw-semibold font-14">USD: 1233.54</span>
                            <span class="mb-0 font-12 text-success">+5.12%</span>
                        </li>
                        <li class="list-inline-item">
                            <img src="{{URL::asset('assets/images/logos/dollar.png')}}" alt="" class="thumb-xs rounded">
                        ...
                        <li class="list-inline-item">
                            <img src="{{URL::asset('assets/images/logos/lite.png')}}" alt="" class="thumb-xs rounded">
                            <span class="fw-semibold font-14">USD: 12.91</span>
                            <span class="mb-0 font-12 text-danger">-1.55%</span>
                        </li>
                        <li class="list-inline-item">
                            <img src="{{URL::asset('assets/images/logos/eth.png')}}" alt="" class="thumb-xs rounded">
...
<div class="row">
    ...
    <div class="col-lg-4">
        <div class="card">
            <div class="card-body">
                <div class="media">
                    <img src="{{URL::asset('assets/images/small/news-2.jpg')}}" height="90" class="me-3" alt="...">
                    <div class="media-body align-self-center">
                        <div class="mb-2">
        ...
        <div class="card">
            <div class="card-body">
                <div class="media">
                    <img src="{{URL::asset('assets/images/small/news-1.jpg')}}" height="90" class="me-3" alt="...">
                    <div class="media-body align-self-center">
                        <div class="mb-2">
        ...
        <div class="card">
            <div class="card-body">
                <div class="media">
                    <img src="{{URL::asset('assets/images/small/news-3.jpg')}}" height="90" class="me-3" alt="...">
                    <div class="media-body align-self-center">
                        <div class="mb-2">
