    ...
    <div class="col-lg-4">
        <div class="card">
            <div class="card-body">
                ...
                <div class="mt-3">
                    <h5 class="font-18 m-0">$33,100</h5>
                    <p class="mb-0 fw-semibold">Total Budget</p>
                </div>
                <div>
                    <p class="text-muted mt-4 mb-1">There are many variations of passages of Lorem Ipsum available,
        ...
        <div class="card">
            <div class="card-body">
                <div class="media mb-3">
                    ...
                    <div class="media-body align-self-center text-truncate ms-2">
                        <h4 class="m-0 fw-semibold text-dark font-16">Organic Farming</h4>
                        <p class="text-muted  mb-0 font-13"><span class="text-dark">Client : </span>Hyman M. Cross</p>
                    </div>
                    <!--end media-body-->
                </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="media mb-3">
                    <img src="{{URL::asset('assets/images/small/project-1.jpg')}}" alt="" class="thumb-md rounded-circle">
                    <div class="media-body align-self-center text-truncate ms-2">
                        <h4 class="m-0 fw-semibold text-dark font-16">Book My World</h4>
                        <p class="text-muted  mb-0 font-13"><span class="text-dark">Client : </span>Hyman M. Cross</p>
                    </div>
                    <!--end media-body-->
                </div>
                ...
                <div class="mt-3">
                    <h5 class="font-18 m-0">$82,000</h5>
                    <p class="mb-0 fw-semibold">Total Budget</p>
                </div>
                <div>
                    <p class="text-muted mt-4 mb-1">There are many variations of passages of Lorem Ipsum available,
        ...
        <div class="card">
            <div class="card-body">
                <div class="media mb-3">
                    <img src="{{URL::asset('assets/images/small/project-3.jpg')}}" alt="" class="thumb-md rounded-circle">
                    <div class="media-body align-self-center text-truncate ms-2">
                        <h4 class="m-0 fw-semibold text-dark font-16">New GPS System</h4>
                        <p class="text-muted  mb-0 font-13"><span class="text-dark">Client : </span>Hyman M. Cross</p>
                    </div>
                    <!--end media-body-->
                </div>
                ...
                <div class="mt-3">
                    <h5 class="font-18 m-0">$35,200</h5>
                    <p class="mb-0 fw-semibold">Total Budget</p>
                </div>
                <div>
                    <p class="text-muted mt-4 mb-1">There are many variations of passages of Lorem Ipsum available,
        ...
        <div class="card">
            <div class="card-body">
                <div class="media mb-3">
                    <img src="{{URL::asset('assets/images/small/project-2.jpg')}}" alt="" class="thumb-md rounded-circle">
                    <div class="media-body align-self-center text-truncate ms-2">
                        <h4 class="m-0 fw-semibold text-dark font-16">Body Care</h4>
                        <p class="text-muted  mb-0 font-13"><span class="text-dark">Client : </span>Hyman M. Cross</p>
                    </div>
                    <!--end media-body-->
                </div>
                ...
                <div class="mt-3">
                    <h5 class="font-18 m-0">$28,500</h5>
                    <p class="mb-0 fw-semibold">Total Budget</p>
                </div>
                <div>
                    <p class="text-muted mt-4 mb-1">There are many variations of passages of Lorem Ipsum available,
