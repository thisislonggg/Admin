...
@slot('title') CalenTeamsdar @endslot
@endcomponent
    ...
    <div class="col-lg-4">
        <div class="card team-card">
            <div class="card-body">
                ...
                <h4 class="m-0 mt-3 font-13 mb-0 fw-semibold">UI/UX Design Team</h4>
                <p class="text-muted mb-0">Contrary to popular belief, Lorem Ipsum is not simply</p>
    ...
    <div class="col-lg-4">
        <div class="card team-card">
            <div class="card-body">
                ...
                <h4 class="m-0 mt-3 font-13 mb-0 fw-semibold">Web Design Team</h4>
                <p class="text-muted mb-0">Contrary to popular belief, Lorem Ipsum is not simply</p>
                <div class="mt-3 d-flex justify-content-between">
                    <div class="img-group">
                        <a class="user-avatar" href="#">
    ...
    <div class="col-lg-4">
        <div class="card team-card">
            <div class="card-body">
                ...
                <h4 class="m-0 mt-3 font-13 mb-0 fw-semibold">Frontend Developer Team</h4>
                <p class="text-muted mb-0">Contrary to popular belief, Lorem Ipsum is not simply</p>
                <div class="mt-3 d-flex justify-content-between">
                    <div class="img-group">
                        <a class="user-avatar" href="#">
