            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-auto align-self-center mx-auto">
                        <div id="wallet_ratio" class="apex-charts"></div>
                    ...
                    <div class="col align-self-center mt-4 mt-lg-0">
                        ...
                        <div class="tab-content my-4">
                            <div class="tab-pane active" id="wallet_BTC" role="tabpanel">
                                <div class="row">
                                    <div class="col-12 col-lg">
                                        <div class="media">
                                            <img src="{{URL::asset('assets/images/logos/btc.png')}}" class="me-2 thumb-xs align-self-center rounded-circle" alt="...">
                                            <div class="media-body align-self-center">
                            ...
                            <div class="tab-pane" id="wallet_ETH" role="tabpanel">
                                <div class="row">
                                    <div class="col">
                                        <div class="media">
                                            <img src="{{URL::asset('assets/images/logos/eth.png')}}" class="me-2 thumb-xs align-self-center rounded-circle" alt="...">
                                            <div class="media-body align-self-center">
                            ...
                            <div class="tab-pane" id="wallet_DASH" role="tabpanel">
                                <div class="row">
                                    <div class="col">
                                        <div class="media">
                                            <img src="{{URL::asset('assets/images/logos/dash.png')}}   " class="me-2 thumb-xs align-self-center rounded-circle" alt="...">
                                            <div class="media-body align-self-center">
                            ...
                            <div class="tab-pane" id="wallet_LTC" role="tabpanel">
                                <div class="row">
                                    <div class="col">
                                        <div class="media">
                                            <img src="{{URL::asset('assets/images/logos/lite.png')}}   " class="me-2 thumb-xs align-self-center rounded-circle" alt="...">
                                            <div class="media-body align-self-center">
                        ...
                        <div class="bg-light p-3 rounded">
                            <div class="row">
                                ...
                                <!--end col-->
                                <div class="col-auto">
                                    <span class="fw-semibold font-14 text-danger">-$2531.00</span>
                                </div>
                                <!--end col-->
                            </div>
                            <!--end row-->
            ...
            <div class="col-lg-6 col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <h2 class="font-18 my-1">$8172.60</h2>
                            </div>
                            <!--end col-->
                            <div class="col-auto">
                                <span class="fw-semibold font-15"><mark>Kraken</mark></span>
                            </div>
                            <!--end col-->
                        </div>
                        <!--end row-->
            ...
            <div class="col-lg-6 col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <h2 class="font-18 my-1">$2243.12</h2>
                            </div>
                            <!--end col-->
                            <div class="col-auto">
                                <span class="fw-semibold font-15"><mark>Bittrex</mark></span>
                            </div>
                            <!--end col-->
                        </div>
                        <!--end row-->
            ...
            <div class="col-lg-6 col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <h2 class="font-18 my-1">$3524.00</h2>
                            </div>
                            <!--end col-->
                            <div class="col-auto">
                                <span class="fw-semibold font-15"><mark>Binance</mark></span>
                            </div>
                            <!--end col-->
                        </div>
                        <!--end row-->
            ...
            <div class="col-lg-6 col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <h2 class="font-18 my-1">$142.00</h2>
                            </div>
                            <!--end col-->
                            <div class="col-auto">
                                <span class="fw-semibold font-15"><mark>Coinex</mark< /span>
                            </div>
                            <!--end col-->
                        </div>
                        <!--end row-->
...
<script src="{{URL::asset('assets/pages/crypto-wallet.init.js')}}"></script>
@endsection
