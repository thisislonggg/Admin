    ...
    <div class="col-12">
                    ...
                    <div class="tab-pane fade show active" id="general_chat">
                        <a href="" class="media new-message">
                            <div class="media-left">
                                <img src="{{URL::asset('assets/images/users/dr-1.jpg')}}" alt="user" class="rounded-circle thumb-md">
                        ...
                        <a href="" class="media new-message">
                            <div class="media-left">
                                <img src="{{URL::asset('assets/images/users/dr-2.jpg')}}" alt="user" class="rounded-circle thumb-md">
                                <span class="round-10 bg-success"></span>
                            </div><!-- media-left -->
                            <div class="media-body">
                                <div>
                        ...
                        <a href="" class="media">
                            <div class="media-left">
                                <img src="{{URL::asset('assets/images/users/dr-5.jpg')}}" alt="user" class="rounded-circle thumb-md">
                        ...
                        <a href="" class="media">
                            <div class="media-left">
                                <img src="{{URL::asset('assets/images/users/dr-3.jpg')}}" alt="user" class="rounded-circle thumb-md">
                                <span class="round-10 bg-secondary"></span>
                            </div><!-- media-left -->
                            <div class="media-body">
                                <div>
                        ...
                        <a href="" class="media">
                            <div class="media-left">
                                <img src="{{URL::asset('assets/images/users/dr-6.jpg')}}" alt="user" class="rounded-circle thumb-md">
                                <span class="round-10 bg-secondary"></span>
                            </div><!-- media-left -->
                            <div class="media-body">
                                <div>
        ...
        <div class="chat-box-right">
            <div class="chat-header">
                <a href="" class="media">
                    <div class="media-left">
                        <img src="{{URL::asset('assets/images/users/dr-4.jpg')}}" alt="user" class="rounded-circle thumb-sm">
                    </div><!-- media-left -->
                    <div class="media-body">
                        <div>
            ...
            <div class="chat-body" data-simplebar>
                <div class="chat-detail">
                    ...
                    <div class="media">
                        ...
                        <!--end media-body-->
                        <div class="media-img">
                            <img src="{{URL::asset('assets/images/users/dr-5.jpg')}}" alt="user" class="rounded-circle thumb-sm">
                        </div>
                    </div>
                    <!--end media-->
            ...
            <div class="chat-footer">
                <div class="row">
                    <div class="col-12 col-md-9">
                        <span class="chat-admin"><img src="{{URL::asset('assets/images/users/dr-5.jpg')}}" alt="user" class="rounded-circle thumb-sm"></span>
