...
@slot('title') Material Design Icons @endslot
@endcomponent
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <p class="text-muted mb-0">Use <code>&lt;i class="mdi
            ...
            <div class="card-body">
                <div class="row icon-demo-content">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <i class="mdi mdi-coin-outline"></i> mdi mdi-coin-outline
                    </div>
                    <div class="col-sm-6 col-md-4 col-lg-3">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <i class="mdi mdi-card-plus"></i> mdi mdi-card-plus
                    </div>
                    <div class="col-sm-6 col-md-4 col-lg-3">
        ...
        <div class="tab-pane" id="drip-icons">
